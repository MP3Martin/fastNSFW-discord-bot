const { REST, Routes, Client, GatewayIntentBits, Collection, ActivityType, ChannelType, Events } = require('discord.js');
...
client.once(Events.ClientReady, async () => {
    client.user.setActivity({
        ...
        name: 'customstatus',
        state: 'Listening to commands, powered by discord.js'
    });
